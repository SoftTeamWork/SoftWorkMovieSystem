...
public class lookiceActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        cur = mMydatabaseAdapter.fetchAllDataice();
        ...
        mlistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
        	{
        		...
        		intent.setClass(lookiceActivity.this, searchiceActivity.class);
        		// 传值 bundle
        ...
        button02.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		Intent intent = new Intent();
        		intent.setClass(lookiceActivity.this, choose01Activity.class);
        		startActivity(intent);
        		lookiceActivity.this.finish();
        	}
        });
