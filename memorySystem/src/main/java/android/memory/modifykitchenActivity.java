...
public class modifykitchenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifykitchenlayout);
      ...
      //获取bundle传值
        ...
        button03.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		new DatePickerDialog(modifykitchenActivity.this,
        ...
        button01.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		else
        		{
            		...
            		mMydatabaseAdapter.modifyDatakitchen(name, name, date, Day, alertday);
            		//mMydatabaseAdapter.modifyDataroom(name, name, date, Day);
            		Toast toast=Toast.makeText(modifykitchenActivity.this, "添加成功！", Toast.LENGTH_LONG);
        		...
        		intent.setClass(modifykitchenActivity.this, searchkitchenActivity.class);
        		// 传值 bundle
        		...
        		modifykitchenActivity.this.finish();
        	}
        });
