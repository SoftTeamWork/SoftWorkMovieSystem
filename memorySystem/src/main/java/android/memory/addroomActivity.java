...
spinner01=(Spinner)this.findViewById(R.id.spinner01);
        ...
        button03.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		new DatePickerDialog(addroomActivity.this,
        	...
        	public void onClick(View v)
        	{
        		...
        		else
        		{
            		...
            		else
            		{
                		...
                		mMydatabaseAdapter.insertDataroom(name, date, Day, alertday, seat);
                		Toast toast=Toast.makeText(addroomActivity.this, "添加成功！", Toast.LENGTH_LONG);
        		...
        		intent.setClass(addroomActivity.this, insertroomActivity.class);
        ...
        button02.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		mMydatabaseAdapter.close();
        		Intent intent= new Intent();
        		intent.setClass(addroomActivity.this, insertActivity01.class);
        		startActivity(intent);
        		addroomActivity.this.finish();
        	}
        });
