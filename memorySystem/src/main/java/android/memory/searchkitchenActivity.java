...
public class searchkitchenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.searchkitchenlayout);
		...
		else
		{
			...
			intent.setClass(searchkitchenActivity.this, emptyActivity.class);
			startActivity(intent);
			searchkitchenActivity.this.finish();
		...
		button01.setOnClickListener(new Button.OnClickListener()
		{
			public void onClick(View v)
			{
				mMydatabaseAdapter.close();
				Intent intent = new Intent();
				intent.setClass(searchkitchenActivity.this, lookkitchenActivity.class);
				startActivity(intent);
				searchkitchenActivity.this.finish();
			}
		});
		...
		button02.setOnClickListener(new Button.OnClickListener()
		{
			...
			{
				Intent intent = new Intent();
				intent.setClass(searchkitchenActivity.this, modifykitchenActivity.class);
