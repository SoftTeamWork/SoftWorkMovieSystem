...
public class modifyroomActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modifyroomlayout);
      ...
      //获取bundle传值
        ...
        button03.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		new DatePickerDialog(modifyroomActivity.this,
        ...
        button01.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		else
        		{
            		...
            		//mMydatabaseAdapter.modifyDataice(name, name, date, Day);
            		//mMydatabaseAdapter.modifyDatakitchen(name, name, date, Day);
            		mMydatabaseAdapter.modifyDataroom(name, name, date, Day, alertday);
            		Toast toast=Toast.makeText(modifyroomActivity.this, "添加成功！", Toast.LENGTH_LONG);
        		...
        		intent.setClass(modifyroomActivity.this, searchroomActivity.class);
        		// 传值 bundle
        ...
        button02.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		mMydatabaseAdapter.close();
        		Intent intent= new Intent();
        		intent.setClass(modifyroomActivity.this, searchActivity.class);
        		// 传值 bundle
        		Bundle bundle = new Bundle();
        		bundle.putString("name", name);
        		intent.putExtras(bundle);
