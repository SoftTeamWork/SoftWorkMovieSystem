...
public class lookroomActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lookicelayout);
        ...
        cur = mMydatabaseAdapter.fetchAllDataroom();
        ...
        mlistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
        	{
        		...
        		intent.setClass(lookroomActivity.this, searchroomActivity.class);
        		// 传值 bundle
        ...
        button01.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		{
        			Intent intent = new Intent();
            		intent.setClass(lookroomActivity.this, searchActivity.class);
            		// 传值 bundle
            		Bundle bundle = new Bundle();
            		bundle.putString("name", name);
            		intent.putExtras(bundle);
        ...
        button02.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		Intent intent = new Intent();
        		intent.setClass(lookroomActivity.this, choose01Activity.class);
        		startActivity(intent);
        		lookroomActivity.this.finish();
        	}
        });
