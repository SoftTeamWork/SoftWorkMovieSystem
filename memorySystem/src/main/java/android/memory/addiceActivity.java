...
public class addiceActivity extends Activity {
	MydatabaseAdapter mMydatabaseAdapter;
	private String name;
	private String date;
	private String day;
	private int alertday;
	private String seat="冰箱";
	private int Day;
      ...
      //获取bundle传值
        ...
        button03.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		new DatePickerDialog(addiceActivity.this,
        ...
        button01.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		else
        		{
            		...
            		if(cur.moveToFirst())
            		{
            			DisplayToast("该食品已经存在！请重新输入或者修改信息...");
            		}
            		else
            		{
                		...
                		mMydatabaseAdapter.insertDataice(name, date, Day, alertday, seat);
                		Toast toast=Toast.makeText(addiceActivity.this, "添加成功！", Toast.LENGTH_LONG);
        		...
        		intent.setClass(addiceActivity.this, inserticeActivity.class);
        ...
        button02.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		mMydatabaseAdapter.close();
        		Intent intent= new Intent();
        		intent.setClass(addiceActivity.this, insertActivity01.class);
        		startActivity(intent);
        		addiceActivity.this.finish();
        	}
        });
