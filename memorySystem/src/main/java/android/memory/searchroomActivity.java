...
public class searchroomActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.searchroomlayout);
		...
		else
		{
			...
			intent.setClass(searchroomActivity.this, emptyActivity.class);
		...
		button01.setOnClickListener(new Button.OnClickListener()
		{
			public void onClick(View v)
			{
				mMydatabaseAdapter.close();
				Intent intent = new Intent();
				intent.setClass(searchroomActivity.this, lookroomActivity.class);
				startActivity(intent);
				searchroomActivity.this.finish();
			}
		});
		...
		button02.setOnClickListener(new Button.OnClickListener()
		{
			...
			{
				Intent intent = new Intent();
				intent.setClass(searchroomActivity.this, modifyroomActivity.class);
